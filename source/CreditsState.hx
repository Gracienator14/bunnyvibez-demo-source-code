...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Vs BunnyVibez Team'],
			['MakoSakura',	    	'sakura',		    'Creator/Director of Vs BunnyVibez',            	'',	'F4109C'],
			['Rozaki',			    'rozaki',		    'Artist/Animator of Vs Bunnyvibez',				    '',	'53E0FF'],
			['Gracienator14',		'none',		    'Musician/Programmer/Charter of Vs BunnyVibez',	            'https://www.youtube.com/channel/UCdutcuiWo18fNETYcMCSYGw',	'EAC15C'],
			[''],
			['Special Thanks'],
			['Juicestain',	    	'none',		    'Earthbound Soundfont Provider',            	    '',	'FFDD33'],
			['Gr33nme93',			'none',		    'Original Concept Art',				                '',		'C30085'],
			['Bugz817',		        'none',		    'Emotional Support',	                            '',			'389A58'],
		    ['Potatocrab',		    'none',		    'Meme Lore',	                                    '',			'389A58'],
			[''],
			['Psych Engine Team'],
